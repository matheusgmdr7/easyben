          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="h-12 border-2 border-gray-200 focus:border-[#0F172A] rounded-lg pr-10"
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border-2 border-gray-200">
                <div className="flex items-center gap-3">
                  <div className={`w-3 h-3 rounded-full ${formData.ativo ? 'bg-[#7BD9F6] bg-opacity-200' : 'bg-red-500'}`}></div>
                  <div>
                ...
                <Button
                  ...
                  size="sm"
                  className={formData.ativo ? "bg-red-600 hover:bg-red-700" : "bg-[#0F172A] hover:bg-[#0F172A]"}
                >
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-gray-600">
                <div>Alterações serão salvas imediatamente</div>
                <div>Senha em branco mantém a atual</div>
                <div>Status ativo/inativo controla acesso</div>
                <div>Permissões podem ser personalizadas</div>
              </div>
            </div>
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-[#7BD9F6] border-opacity-30 rounded-xl p-6">
                <div className="flex items-center gap-3 mb-3">
                  <div className="p-2 bg-[#7BD9F6] bg-opacity-30 rounded-lg">
                    <Edit2 className="h-5 w-5 text-[#0F172A]" />
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                  ...
                  <div className="bg-white/60 rounded-lg p-3">
                    ...
                    <div className="text-[#0F172A] mt-1">{formData.ativo ? 'Ativo' : 'Inativo'}</div>
                  </div>
                </div>
              </div>
            )}
