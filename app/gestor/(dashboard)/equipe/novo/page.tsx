...
import { Link as LinkIcon, Copy, CheckCircle, AlertCircle } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-gray-50 to-white rounded-lg border border-gray-200 shadow-sm p-4 md:p-6">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 tracking-tight font-sans">Adicionar Corretor</h1>
            <p className="text-gray-600 mt-1 font-medium">Compartilhe o link de cadastro para adicionar corretores à sua equipe</p>
          </div>
        </div>
      </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-blue-800">
                    ...
                    <ul className="list-disc list-inside space-y-1 text-blue-700">
                      ...
                      <li>Compartilhe com corretores que deseja adicionar à sua equipe</li>
                      <li>Quando um corretor se cadastrar usando este link, ele será automaticamente vinculado à sua equipe</li>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Corretores que se cadastrarem usando este link serão automaticamente vinculados à sua equipe.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-[#0F172A] mt-0.5 flex-shrink-0" />
              <div>
                <p className="font-semibold text-gray-900">Acompanhamento de Desempenho</p>
                <p className="text-sm text-gray-600 mt-1">
                  Você poderá visualizar todas as propostas, comissões e estatísticas de cada corretor da sua equipe.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
