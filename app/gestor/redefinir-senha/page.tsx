...
export default function RedefinirSenhaGestorPage() {
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            ...
            <div className="flex flex-col gap-3">
              <Link href="/gestor/recuperar-senha">
                <Button className="w-full bg-[#0F172A] hover:bg-[#1E293B]">
                  Solicitar nova redefinição de senha
                </Button>
              </Link>
              <Link href="/gestor/login" className="text-[#0F172A] hover:underline text-sm font-medium">
                Voltar para o login
              </Link>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="text-center text-sm text-gray-600">
              <Link href="/gestor/login" className="text-[#0F172A] hover:underline font-medium">
                Voltar para o login
              </Link>
            </div>
          </form>
