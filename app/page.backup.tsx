  ...
  return (
    <>
      ...
      <main className="flex-grow">
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
              <div className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                <div className="bg-[#0F172A] p-4 md:p-6 text-white">
        ...
        {/* CTA Section */}
        <section className="py-12 md:py-20 bg-gradient-to-r from-[#0F172A] to-[#1E293B] text-white">
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <CustomButton
                  href="/contato"
                  size="lg"
                  className="bg-white text-[#0F172A] hover:bg-white/90 rounded-full font-medium"
                >
