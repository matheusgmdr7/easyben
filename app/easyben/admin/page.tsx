...
export default function EasyBenPlataformasPage() {
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Gerencie e configure todas as plataformas dos seus clientes white-label
          </p>
        </div>
        <Button 
                    ...
                    <TableCell className="text-right">
                      <div className="flex justify-end gap-2">
                        ...
                        <Button
                          ...
                          asChild
                        >
                          <Link href={`/${tenant.slug}`} target="_blank" className="inline-flex">
