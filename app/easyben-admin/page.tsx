    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Globe className="h-4 w-4 text-[#00C6FF]" />
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <TrendingUp className="h-4 w-4 text-[#00C6FF]" />
          </CardHeader>
          <CardContent>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card className="hover:shadow-md transition-shadow">
          <CardHeader>
            <CardTitle className="flex items-center">
              <Globe className="h-5 w-5 mr-2 text-[#00C6FF]" />
          ...
          <CardContent>
            <Button asChild className="w-full bg-[#00C6FF] hover:bg-[#00B8E6] text-white">
        ...
        <Card className="hover:shadow-md transition-shadow">
          <CardHeader>
            <CardTitle className="flex items-center">
              <Building2 className="h-5 w-5 mr-2 text-[#00C6FF]" />
              Gerenciar Clientes
            </CardTitle>
            <CardDescription>
        ...
        <Card className="hover:shadow-md transition-shadow">
          <CardHeader>
            <CardTitle className="flex items-center">
              <Users className="h-5 w-5 mr-2 text-[#00C6FF]" />
              Configurar Serviços
            </CardTitle>
            <CardDescription>
